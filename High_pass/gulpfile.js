...
const path = {
  ...
  src: {
    ...
    css: [source_folder + '/scss/**/*.scss', '!'+source_folder+'/scss/breakpoints/**.**'],
...
const build = gulp.series(clean,svgSprites, resources, favicon,gulp.parallel(js, css,  breakpoints, html,  images, fonts)) 
